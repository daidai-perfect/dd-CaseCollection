...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"CASE","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0"},{"hid":"description","name":"description","content":"CASE"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Fbitbug_favicon.ico"},{"rel":"stylesheet","href":"\u002Fcss\u002Fanimate.css"}],"style":[],"script":[]},
